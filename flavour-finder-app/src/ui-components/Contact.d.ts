...
export declare type ContactProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: ContactInputValues) => ContactInputValues;
    onSuccess?: (fields: ContactInputValues) => void;
    onError?: (fields: ContactInputValues, errorMessage: string) => void;
