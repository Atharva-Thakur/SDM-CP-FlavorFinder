  ...
  return (
    ...
    >
      ...
      <View
        width="unset"
        height="1px"
        {...getOverrideProps(overrides, "Divider3520")}
      ></View>
      <Flex
        gap="24px"
        direction="row"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 4053521")}
      >
        <Flex
          gap="8px"
          direction="column"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 4053534")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
      ...
      <View
        width="unset"
        height="1px"
        {...getOverrideProps(overrides, "Divider3539")}
      ></View>
      <Flex
        gap="0"
        direction="row"
