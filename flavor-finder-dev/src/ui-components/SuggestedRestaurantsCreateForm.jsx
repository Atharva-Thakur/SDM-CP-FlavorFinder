...
import { createSuggestedRestaurants } from "../graphql/mutations";
export default function SuggestedRestaurantsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createSuggestedRestaurants.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SuggestedRestaurantsCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
